...
DATABASE_URL = os.getenv(
    "DATABASE_URL", "postgresql://admin:securepassword123@localhost:5432/nuhach"
)
...
def main():
    ...
    parser.add_argument(
        "--parquet", type=str, default=PARQUET_PATH, help="Path to parquet file with embeddings"
    )
    parser.add_argument(
        "--truncate", action="store_true", help="Truncate perfume_search table before inserting"
    )
